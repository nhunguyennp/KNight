...
class BLECentralViewController : UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverDescriptorsFor characteristic: CBCharacteristic, error: Error?) {
        ...
        if ((characteristic.descriptors) != nil) {
            ...
            for x in characteristic.descriptors!{
                ...
                print("Rx Value \(String(describing: rxCharacteristic?.properties))")
                print("Tx Value \(String(describing: txCharacteristic?.properties))")
            }
        }
    }
    ...
    func peripheral(_ peripheral: CBPeripheral, didWriteValueFor characteristic: CBCharacteristic, error: Error?) {
        guard error == nil else {
            print("Error discovering services for didWriteValueFor characteristic: \(String(describing: error))")
            return
        }
        print("Message sent")
    }
    ...
    func peripheral(_ peripheral: CBPeripheral, didWriteValueFor descriptor: CBDescriptor, error: Error?) {
        guard error == nil else {
            print("Error discovering services for didWriteValue for descriptor: \(String(describing: error))")
            return
        }
        print("Succeeded!")
    }
